...
> **Decisão de 11/08/2026: a foto NÃO sobe.** As 32 mil capturas dariam 130 a 250 GB
> no storage do Supabase, e o Álvaro cortou essa linha. `hairmetrix_imagens` fica
> zerada de propósito. A leitura visual do laudo é **montada a partir das medidas**
> — feixe de fios, perfil do couro cabeludo e campo folicular, todos derivados do
> histograma de espessura e das contagens. Ver `src/lib/campoFolicular.ts`.
> O resto desta seção fica documentado para o caso de alguém precisar subir uma
> foto avulsa; a edge function ainda aceita `action: 'imagem'`.
