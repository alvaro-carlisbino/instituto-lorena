        ...
        ? [
            ...
            ...(context.leadId
              ? [
                  ...
                  'MARCAÇÃO AUTOMÁTICA: quando o paciente aceitar agendar, disser "pode marcar", "quero a primeira vaga", confirmar período (manhã/tarde), dias da semana ou aceitar proposta sua, inclua na MESMA resposta (após o texto ao paciente) o bloco <<<CRM_OPS>>> com book_appointment. Ex.: {"version":1,"ops":[{"type":"book_appointment","duration_minutes":30,"notes":"Transplante capilar masculino; prefere manhã"}]} — duration_minutes: 30 para consulta/triagem habitual, 60 se pedirem avaliação mais longa. O servidor usa salas ativas (snapshot) e find_first_appointment_slot nas próximas 2 semanas; não prometa data concreta ao paciente antes do texto da mensagem — o sistema acrescenta confirmação de horário quando a marcação for criada. Não convide o paciente a olhar agenda ou plataforma — isso é interno.',
