...
export const NAV_DESTINATIONS: NavDestination[] = [
  ...
  // ── Kits (24/09/2026): cada tela é um item do menu. Antes eram abas dentro de "Kits cirúrgicos",
  // com a Conferência do SPA num botão escondido e uma barra de abas do estoque inteiro por cima.
  {
    id: 'kits-montar',
    path: '/kits/montar',
    label: 'Montar kit',
    icon: Boxes,
    group: 'kits',
    keywords: ['bandeja', 'cirurgia', 'montagem', 'bipar kit', 'separar material'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  {
    id: 'kits',
    path: '/kits',
    label: 'Kits dos pacientes',
    icon: PackageCheck,
    group: 'kits',
    keywords: ['kit cirúrgico', 'registrar uso', 'devolução', 'sobra', 'editar kit', 'conta do paciente'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  {
    id: 'conferencia-spa',
  ...
  },
  {
    id: 'kits-modelos',
    path: '/kits/modelos',
    label: 'Modelos de kit',
    icon: Layers,
    group: 'kits',
    keywords: ['modelo', 'lista do kit', 'kit padrão', 'folha do kit'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  {
    id: 'kits-controlados',
    ...
    icon: ShieldAlert,
    group: 'kits',
    keywords: ['controlado', 'portaria 344', 'psicotrópico', 'livro'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  {
    id: 'conta-cirurgica',
    ...
    icon: FileBarChart2,
    group: 'kits',
    keywords: ['custo', 'cirurgia', 'fechamento', 'hora sala'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },

  // ── CME: esterilização em três telas (ciclos, pacotes, cadastro)
  {
    id: 'cme',
    path: '/cme',
    label: 'Ciclos da autoclave',
    icon: FlaskConical,
    group: 'cme',
    keywords: ['autoclave', 'ciclo', 'etiqueta', 'esterilização', 'lote', 'zebra', 'cme'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  {
    id: 'cme-pacotes',
    path: '/cme/pacotes',
    label: 'Pacotes e validade',
    icon: PackageSearch,
    group: 'cme',
    keywords: ['pacote', 'validade', 'vencido', 'rastreabilidade', 'qr', 'etiqueta cme'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  {
    id: 'cme-cadastro',
    path: '/cme/cadastro',
    label: 'Cadastro da CME',
    icon: Settings2,
    group: 'cme',
    keywords: ['material cme', 'colaborador', 'autoclave'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  {
    id: 'cme-etiqueta',
    path: '/cme/etiqueta',
    label: 'Etiqueta e impressora',
    icon: Printer,
    group: 'cme',
    keywords: ['zebra', 'etiqueta', 'impressora', 'zd220', 'browser print', 'teste de etiqueta', 'tamanho da etiqueta'],
    visible: (ctx) => isClinic(ctx) && canBoards(ctx),
  },
  ...
  },
  {
    ...
    icon: ScanBarcode,
    group: 'estoque',
    keywords: ['bipagem', 'código de barras', 'leitor', 'baixa', 'saída avulsa', 'entrada sem nota', 'scanner'],
    visible: canBoards,
  },
  {
    id: 'transferencias',
  ...
  },
  {
    ...
    icon: Warehouse,
    group: 'estoque',
    keywords: ['setor', 'depósito', 'almoxarifado', 'centro cirúrgico', 'spa', 'setor padrão'],
    visible: canBoards,
  },
  {
    ...
    icon: MapPin,
    group: 'estoque',
    keywords: ['endereçamento', 'prateleira', 'armário', 'localização', 'onde fica', 'etiqueta de prateleira'],
    visible: canBoards,
  },
  {
    id: 'estoque-codigos',
  ...
  },
  {
    ...
    icon: FileBarChart2,
    group: 'estoque',
    keywords: ['giro', 'consumo', 'curva abc', 'valor em estoque'],
    visible: canBoards,
  },
  {
  ...
  },
  {
    ...
    icon: ClipboardList,
    group: 'compras',
    keywords: ['fornecedor', 'pedido de compra', 'aprovar compra'],
    visible: canBoards,
  },
  ...
  },
  {
    ...
    icon: Megaphone,
    group: 'relatorios',
    // É assim que o pedido chega: "quanto a gente gastou no facebook esse mês".
    keywords: ['meta', 'facebook', 'instagram', 'tráfego', 'trafego', 'verba', 'campanha', 'cpl', 'roas', 'gasto', 'mídia', 'midia'],
    visible: (ctx) => isClinic(ctx) && canRoute(ctx),
  },
  {
    id: 'analytics',
