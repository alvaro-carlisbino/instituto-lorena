    ...
    <div className="rounded-xl border border-border/40 bg-card/50 p-6 transition-all hover:bg-card/80">
      ...
      <div className="mt-4 grid grid-cols-3 gap-3 border-t border-border/20 pt-4">
        <div>
          ...
          <p className="mt-1 text-lg sm:text-2xl font-bold tabular-nums tracking-tight text-foreground">{spend > 0 ? brl(cac) : '—'}</p>
        ...
        <div>
          ...
          <p className="mt-1 text-lg sm:text-2xl font-bold tabular-nums tracking-tight text-emerald-600">{spend > 0 ? `${roas.toFixed(1)}x` : '—'}</p>
        ...
        <div>
          ...
          <p className="mt-1 text-lg sm:text-2xl font-bold tabular-nums tracking-tight text-foreground">{brl(revenueCents)}</p>
        </div>
      </div>
    </div>
  )
