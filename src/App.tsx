...
const PreAgendamentosPage = lazyPage(() => import('./pages/PreAgendamentosPage'), 'PreAgendamentosPage')
...
const ResultadoCirurgiasPage = lazyPage(() => import('./pages/ResultadoCirurgiasPage'), 'ResultadoCirurgiasPage')
...
const TricoscopiaPacientePage = lazyPage(() => import('./pages/TricoscopiaPacientePage'), 'TricoscopiaPacientePage')
...
const TransferenciaEditarPage = lazyPage(() => import('./pages/TransferenciaEditarPage'), 'TransferenciaEditarPage')
  ...
  return (
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        ...
        <Route path="/tricoscopia/:pacienteId" element={<TricoscopiaPacientePage />} />
        ...
        <Route path="/resultado-cirurgias" element={<CobrancaDaVenda><ResultadoCirurgiasPage /></CobrancaDaVenda>} />
        ...
        <Route path="/transferencias-estoque/:id" element={<TransferenciaEditarPage />} />
