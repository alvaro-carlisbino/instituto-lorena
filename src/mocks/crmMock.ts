...
export const initialInteractions: Interaction[] = [
  ...
  },
  {
    ...
    // Mensagem de WhatsApp de verdade TEM id externo, e é ele que destranca responder,
    // reagir, editar e apagar no aparelho da pessoa. Sem isto no mock, o modo demo mostrava
    // um menu de bolha pela metade e dava a impressão de que a função não existia.
    externalMessageId: 'wapi-demo-0003',
  },
  {
    id: 'int-005',
    leadId: 'lead-002',
    ...
    direction: 'in',
    author: 'Paulo Neri',
    content: 'Oi! Pode sim. Queria entender o valor e como funciona a consulta.',
    happenedAt: '2026-04-16T11:34:00Z',
    externalMessageId: 'wapi-demo-0005',
    replyToExternalId: 'wapi-demo-0003',
  },
  {
    id: 'int-006',
    leadId: 'lead-002',
    ...
    direction: 'out',
    author: 'Bruno Lima',
    content: 'Claro! A avaliacao leva 40 minutos e ja sai com o plano de tratamento.',
    happenedAt: '2026-04-16T11:36:00Z',
    externalMessageId: 'wapi-demo-0006',
    replyToExternalId: 'wapi-demo-0005',
    reactions: [{ emoji: '👍', direction: 'in', author: 'contato', mine: false }],
  },
  {
    id: 'int-004',
    leadId: 'lead-003',
...
export const initialWorkflowFields: WorkflowField[] = [
  ...
  {
    id: 'wf-1',
    fieldKey: 'tipo_consulta',
    label: 'Tipo de consulta',
    fieldType: 'select',
    required: true,
    options: [
      { value: 'transplante', label: 'Consulta Transplante' },
      { value: 'clinica', label: 'Consulta Clínica' },
      { value: 'acompanhamento', label: 'Consulta de Acompanhamento' },
      { value: 'online', label: 'Consulta On-line' },
      { value: 'sobrancelhas', label: 'Consulta Transplante de Sobrancelhas' },
    ],
    section: 'Comercial',
    sortOrder: 10,
